...
Else
    ...
    sqlX = "select a.kdbarang,b.nmbarang,b.kdkategori,a.unit,b.satuan,a.keterangan,NMBARANG1 = CASE WHEN b.kd1 <>'' THEN B.NMBARANG + '    ' + b.kd1 WHEN b.kdSAP <>'' THEN b.nmbarang + '    ' +b.kdSAP ELSE b.nmbarang END from sewa_d a left join barang b " & vbCrLf & _
...
sql = "select a.kdbarang,b.kd1,b.nmbarang,a.unit,b.satuan,a.harga,a.rupiah,a.keterangan,a.kdsewa_d from sewa_d a left join barang b " & vbCrLf & _
      "on a.kdbarang=b.kdbarang where a.kdsewa='" & lblkdsewa & "' order by a.tglinput "
...
Else
    ...
    Else
        ...
        If lblkode = 1 Then
            ...
            sql = "insert into sewa_d select kdbarang  + '" & "_" & lblkdsewa & "','" & lblkdsewa & "',kdbarang,sisa,0,0,keterangan,tglinput from (" & sqlA2 & ") a where sisa<>0 "
            con.Execute (sql)
