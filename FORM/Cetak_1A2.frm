...
Else
sql1 = "select '0' As srt,'' as judul,'" & Format(txttgl1, "yyyy/MM/dd") & "' as tglbukti,'SALDO AWAL' as nobukti,'' as nosj,'' as nmcustomer,a.kdgudang,a.kdbarang,a.nmbarang,'' as keterangan,sum(a.masuk) as masuk,sum(a.keluar) as keluar,0 as H_masuk,0 as H_keluar,sum(rp_masuk) as rp_masuk,sum(rp_keluar) as rp_keluar,a.kd1,'' as x1  from rinci_stok a where a.kd1='" & lblkd1 & "' and a.kdgudang='" & lblkdgudang & "' " & vbCrLf & _
       "and a.tglbukti < '" & Format(txttgl1, "yyyy/MM/dd") & "' group by a.kdgudang,a.kdbarang,a.nmbarang,a.kd1"
       
sql2 = "select a.*,(a.judul + ' - ' + a.keterangan + ' - ' + a.kdbarang) as x1  from rinci_stok a where a.kd1='" & lblkd1 & "' and a.kdgudang='" & lblkdgudang & "' " & vbCrLf & _
       "and a.tglbukti between '" & Format(txttgl1, "yyyy/MM/dd") & "'  and '" & Format(txttgl2, "yyyy/MM/dd") & "'"
End If
...
If chkBP.Value = 0 Then
.lblnmbarang = lblnmbarang & "( " & lblkdbarang & " )"
Else
.lblnmbarang = lblnmbarang & "( " & lblkd1 & " )"
End If
...
Else
sql1 = "select '0' As srt,'' as judul,'" & Format(txttgl1, "yyyy/MM/dd") & "' as tglbukti,'SALDO AWAL' as nobukti,'' as nosj,'' as nmcustomer,a.kdgudang,a.kdbarang,a.nmbarang,'' as keterangan,sum(a.masuk) as masuk,sum(a.keluar) as keluar,0 as H_masuk,0 as H_keluar,sum(rp_masuk) as rp_masuk,sum(rp_keluar) as rp_keluar,'' as x1  from rinci_stok a where a.kd1='" & lblkd1 & "' and a.kdgudang='" & lblkdgudang & "' " & vbCrLf & _
       "and a.tglbukti < '" & Format(txttgl1, "yyyy/MM/dd") & "' group by a.kdgudang,a.kdbarang,a.nmbarang,a.kd1"
