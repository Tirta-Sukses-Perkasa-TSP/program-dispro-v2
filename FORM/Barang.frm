...
Barang_TU.lblkdbarang_mars = rs!kdbarang_mars
Barang_TU.lbljnsbrg_MARS = rs!jnsbrg_mars
Barang_TU.lblstatus_kepemilikan = rs!Status_kepemilikan
...
If ChkR.Value = 0 Then
    ...
    sql = "select a.kdbarang,a.kd1,a.kdsap,a.nmbarang,a.merk,a.satuan,a.kdkategori,b.nmkategori,a.keterangan,a.non_aktif, " & vbCrLf & _
          "N_aktif = case when a.non_aktif=1 then 'X' else '' end,a.tglnon_aktif,a.BFS,a.Unit_BFS,a.kdbarang_MARS,a.jnsbrg_MARS,a.status_kepemilikan from barang a left join kategoriBRG b on a.kdkategori =b.kdkategori order by a.kdbarang"
    Else
    sql = "select a.kdbarang,a.kd1,a.kdsap,a.nmbarang,a.merk,a.satuan,a.kdkategori,b.nmkategori,a.keterangan,a.non_aktif, " & vbCrLf & _
          "N_aktif = case when a.non_aktif=1 then 'X' else '' end,a.tglnon_aktif,a.BFS,a.Unit_BFS,a.kdbarang_MARS,a.jnsbrg_MARS,a.status_kepemilikan from barang a left join kategoriBRG b on a.kdkategori =b.kdkategori where " & kategori & " like '%" & txtcari & "%' order by a.kdbarang"
    End If
