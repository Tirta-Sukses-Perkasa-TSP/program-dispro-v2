...
sql3 = "select kdcustomer_iap, SUM(qty_gln1) as qty_gln1,SUM(qty_gln2) as qty_gln2,SUM(qty_gln3) as qty_gln3,SUM(qty_sps1) as qty_sps1,SUM(qty_sps2) as qty_sps2,SUM(qty_sps3) as qty_sps3 from ( " & vbCrLf & _
            "select kdcust_IAP as kdcustomer_iap,qty_gln as qty_gln1,qty_cup + qty_btl as qty_SPS1,0 as qty_gln2,0 as qty_sps2,0 as qty_gln3,0 as qty_sps3 from " & CMbDbase & "..V_Rekap_OMSET_TSP where bulan=" & cmbbln.Text & " Union all" & vbCrLf & _
            "select kdcust_IAP as kdcustomer_iap,0 as qty_gln1,0 as qty_sps1,qty_gln as qty_gln2,qty_cup + qty_btl as qty_SPS2,0 as qty_gln3,0 as qty_sps3 from " & cmbDbase2 & "..V_Rekap_OMSET_TSP where bulan=" & cmbbln2.Text & " Union all" & vbCrLf & _
            "select kdcust_IAP as kdcustomer_iap,0 as qty_gln1,0 as qty_sps1,0 as qty_gln2,0 as qty_sps2,qty_gln as qty_gln3,qty_cup + qty_btl as qty_SPS3 from " & cmbDbase3 & "..V_Rekap_OMSET_TSP where bulan=" & cmbbln3.Text & " " & vbCrLf & _
       ") x group by kdcustomer_IAP"

sql4 = "select kdcustomer,'X' as ket_sewa from rekap_sewa where sisa<>0 group by kdcustomer"
...
.lblthn1 = Right(CMbDbase, 4)
.lblthn2 = Right(cmbDbase2, 4)
.lblthn3 = Right(cmbDbase3, 4)
