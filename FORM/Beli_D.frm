...
Dim sqlACC, sqlCS, sqlCS1 As String
...
sqlCS1 = "select kdbarang,sum(U_beli + U_Rpinjam + U_Rsewa + M_unit - U_free - U_pinjam - U_sewa  - K_unit - repair) as Unit,0 as UKeluar" & vbCrLf & _
         "from RKP_stok where kdgudang='" & lblkdgudang & "' and tgl <= '" & Format(txttglBPB, "yyyy/MM/dd") & "' and kdbarang in (select kdbarang from beli_d where kdbeli='" & txtkdPO & "_" & lblnoBPB & "') group by kdbarang"
...
Cancel = 1
    ...
    If ms = vbYes Then
    List_Stok_selisih.lblkode = "BELI"
