...
sql = "select a.kdbarang,b.kd1,b.nmbarang,a.unit,b.satuan,a.harga,a.rupiah,a.keterangan,a.kdperbaikan_d,a.klik_hrg from perbaikan_d a left join barang b " & vbCrLf & _
      "on a.kdbarang=b.kdbarang where a.kdperbaikan='" & lblKDPerbaikan & "' order by a.tglinput "
...
Else
    ...
    Else
        ...
        If lblkode = 1 Then
            ...
            sql = "insert into perbaikan_d select kdbarang  + '" & "_" & lblKDPerbaikan & "','" & lblKDPerbaikan & "',kdbarang,unit,0,0,keterangan,0,tglinput from PO_d where kdPO='" & txtkdPO & "'"
            con.Execute (sql)
