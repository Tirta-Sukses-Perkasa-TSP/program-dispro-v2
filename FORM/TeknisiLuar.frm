...
ElseIf Index = 5 Then
    ...
    If OPT1.Value = True Then
    TeknisiLuar_list.lblket_tgl = "tglkomplain"
    TeknisiLuar_list.lbljudul_tgl = "TGL KOMPLAIN"
    Else
    TeknisiLuar_list.lblket_tgl = "TGLRENCANA"
    TeknisiLuar_list.lbljudul_tgl = "TGL RENCANA"
    End If
