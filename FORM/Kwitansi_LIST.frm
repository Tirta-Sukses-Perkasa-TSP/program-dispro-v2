...
ElseIf lblFRM = "POSTING" Then
    sqlA1 = "select kdcustomer,sum(unit) as unit from (" & vbCrLf & _
           ...
           "where b.tglRsewa <='" & Format(Posting.txttglposting, "yyyy/MM/dd") & "' and b.rtr=1 group by b.kdsewa,b.kdcustomer,A.kdbarang" & vbCrLf & _
...
ElseIf lblFRM = "POSTING" Then
    ...
    sqlA = "select kdcustomer,sum(unit) as unit from (" & vbCrLf & _
           ...
           "where b.tglRsewa <='" & Format(Posting.txttglposting, "yyyy/MM/dd") & "' and b.rtr=1 group by a.kdsewa,b.kdcustomer,a.kdbarang" & vbCrLf & _
           " ) a group by kdcustomer"
...
If lblFRM = "KWITANSI" Then
    ...
    sql = "select 'X' as PKP,a.kdpiutang,b.npwp,b.nmNPWP,b.alamatNPWP,a.unit,(a.jmlpiutang/a.unit) as harga,(a.jmlpiutang/a.unit) / 1.11 as harga1 from piutangsewa a " & vbCrLf & _
          "left join customer b on a.kdcustomer=b.kdcustomer where " & kata & " and a.tahun=" & Kwitansi.txttahun & "  and len(b.npwp) > 3 Union All" & vbCrLf & _
          "select '' as PKP,a.kdpiutang,'' as npwp,b.nmcustomer as nmnpwp,alamat as alamatNPWP,a.unit,(a.jmlpiutang/a.unit) as harga,(a.jmlpiutang/a.unit) / 1.11 as harga1 from piutangsewa a " & vbCrLf & _
          "left join customer b on a.kdcustomer=b.kdcustomer where " & kata & " and a.tahun=" & Kwitansi.txttahun & "  and len(b.npwp) <= 3 "
