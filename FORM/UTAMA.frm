...
Begin VB.MDIForm UTAMA 
   ...
   Begin VB.Menu mnMenu 
      ...
      Begin VB.Menu mnL1 
         ...
         End
         Begin VB.Menu mnL2A1 
            Caption         =   "&7. Cetak Tanda Terima Piutang"
            Index           =   8
         End
      End
      Begin VB.Menu mnL1 
      ...
      Begin VB.Menu mnL1 
         ...
         End
         Begin VB.Menu mnL7A1 
            Caption         =   "&6. Check List Pembaharuan SPP"
            Index           =   6
         End
      End
      Begin VB.Menu mnL1 
   ...
   End
   Begin VB.Menu mnV 
      Caption         =   "&VERSI 5 Sept 2022"
      Enabled         =   0   'False
   End
   Begin VB.Menu mnReport 
      Caption         =   "&Report Marketing"
      Index           =   0
      Begin VB.Menu mnRA 
         Caption         =   "&A. Penjualan IAP (STT)"
         Index           =   0
         Begin VB.Menu mnRA_1 
            Caption         =   "&1. By Customer"
            Index           =   0
         End
         Begin VB.Menu mnRA_1 
            Caption         =   "&2. By List Customer (Excel)"
            Index           =   1
         End
         Begin VB.Menu mnRA_1 
            Caption         =   "&3. By PIC Marketing"
            Index           =   2
         End
         Begin VB.Menu mnRA_1 
            Caption         =   "-"
         ...
         End
         Begin VB.Menu mnRA_1 
            Caption         =   "&4. By Kata Pencarian"
            Index           =   4
         End
      End
      Begin VB.Menu mnRA 
         Caption         =   "&B. Analisa Penjualan IAP (STT)"
         Index           =   1
         Begin VB.Menu mnRB_1 
            Caption         =   "&1. CustomerBuy/Not Buy"
            Index           =   0
         End
      End
   End
...
Private Sub mn7A1_Click(Index As Integer)
...
ElseIf Index = 5 Then
Cetak_6A5.Show vbModal
ElseIf Index = 6 Then
Print_Form_MARS.Show vbModal
...
Private Sub mnRA_1_Click(Index As Integer)
On Error GoTo hell
Call Koneksi_dbase
...
Rpt_A.Show vbModal
ElseIf Index = 1 Then
X_Rpt_A2.Show vbModal
ElseIf Index = 2 Then
X_Rpt_A3.Show vbModal
ElseIf Index = 4 Then
X_Rpt_A4.Show vbModal
...
Private Sub mnRB_1_Click(Index As Integer)
On Error GoTo hell
Call Koneksi_dbase

If Index = 0 Then

X_Rpt_B1.Show vbModal
