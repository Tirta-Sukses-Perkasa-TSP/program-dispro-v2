...
On Error GoTo hell
    ...
    Else
         ...
         con.Execute ("insert into PO_D values ('" & lblkdbarang & "_" & Pinjam_D.txtkdPO & "','" & Pinjam_D.txtkdPO & "','" & lblkdbarang & "'," & CCur(txtunit) & ",'" & UCase(txtketerangan) & "',getdate())")
         con.Execute ("insert into Pinjam_D values ('" & lblkdbarang & "_" & Pinjam_D.lblkdPinjam & "','" & Pinjam_D.lblkdPinjam & "','" & lblkdbarang & "'," & CCur(txtunit) & "," & CCur(txtharga) & "," & CCur(lblrupiah) & ",'" & UCase(txtketerangan) & "',getdate())")
