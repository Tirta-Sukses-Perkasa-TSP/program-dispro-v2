...
Else
    ...
    ms = MsgBox("Apakah anda ingin menghapus Semua data ?", vbQuestion + vbYesNo, "Pertanyaan !")
    If ms = vbYes Then
        sql = "delete from Rpinjam_d where kdRpinjam ='" & lblKDRPinjam & "'"
        con.Execute (sql)
        TimerAll.Interval = 10
    End If
