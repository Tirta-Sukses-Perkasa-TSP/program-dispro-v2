...
'On Error GoTo hell
    ...
    Else
         ...
         con.Execute ("insert into PO_D values ('" & lblkdbarang & "_" & Sewa_d.txtkdPO & "','" & Sewa_d.txtkdPO & "','" & lblkdbarang & "'," & CCur(txtunit) & ",'" & UCase(txtketerangan) & "',getdate())")
         con.Execute ("insert into sewa_D values ('" & lblkdbarang & "_" & Sewa_d.lblkdsewa & "','" & Sewa_d.lblkdsewa & "','" & lblkdbarang & "'," & CCur(txtunit) & "," & CCur(txtharga) & "," & CCur(lblrupiah) & ",'" & UCase(txtketerangan) & "',getdate())")
