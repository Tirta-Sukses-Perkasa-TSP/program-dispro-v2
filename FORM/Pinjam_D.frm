...
Else
    ...
    sqlX = "select a.kdbarang,b.kd1,b.nmbarang,b.kdkategori,a.unit,b.satuan,a.keterangan,NMBARANG1 = CASE WHEN b.kd1 <>'' THEN B.NMBARANG + '    ' + b.kd1 WHEN b.kdSAP <>'' THEN b.nmbarang + '    ' +b.kdSAP ELSE b.nmbarang END from pinjam_d a left join barang b " & vbCrLf & _
    ...
    .fldnmbarang.DataField = "nmbarang1"
...
sql = "select a.kdbarang,b.kd1,b.nmbarang,a.unit,b.satuan,a.harga,a.rupiah,a.keterangan,a.kdpinjam_d from pinjam_d a left join barang b " & vbCrLf & _
      "on a.kdbarang=b.kdbarang where a.kdpinjam='" & lblkdPinjam & "' order by a.tglinput "
...
Else
    ...
    Else
        ...
        If lblkode = 1 Then
            ...
            sqlA1 = "select a.kdbarang,b.nmbarang,a.unit,isnull(c.Ukeluar,0) as Ukeluar,b.satuan,a.keterangan,a.kdpo_d,a.tglinput from po_d a left join barang b " & vbCrLf & _
                    "on a.kdbarang=b.kdbarang left join (" & sqlA & ") c on a.kdPO=c.kdPO and a.kdbarang=c.kdbarang where a.kdpo='" & txtkdPO & "' "
            
            sqlA2 = "select kdbarang,nmbarang,unit,ukeluar,unit - ukeluar as sisa,satuan,keterangan,kdPO_D,tglinput from (" & sqlA1 & ") a  "
            ...
            sql = "insert into pinjam_d select kdbarang  + '" & "_" & lblkdPinjam & "','" & lblkdPinjam & "',kdbarang,sisa,0,0,keterangan,tglinput from (" & sqlA2 & ") a where sisa<>0 "
            con.Execute (sql)
