...
sql = "select * from V_kunjungan_TL where " & lblket_tgl & " between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' order by tglrencana,umur desc,nmcustomer"
Else
sql = "select * from V_kunjungan_TL where " & lblket_tgl & "  between '" & Format(txttgl1, "yyyy/MM/dd") & "' and '" & Format(txttgl2, "yyyy/MM/dd") & "' and kdteknisi='" & lblkdteknisi & "' order by tglrencana,umur desc,nmcustomer"
End If
